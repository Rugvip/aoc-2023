...
export type X<TVec2 extends Vec2> = TVec2 extends `${infer IX extends number},${any}` ? IX : never;
export type Y<TVec2 extends Vec2> = TVec2 extends `${any},${infer IY extends number}` ? IY : never;
